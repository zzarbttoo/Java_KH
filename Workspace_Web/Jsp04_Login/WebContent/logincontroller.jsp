<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<%@ page import="com.login.dao.*" import="com.login.dto.*"
...
<body>
	...
	<%
		...
		System.out.println("이게 숫자냐");
		System.out.println(myno);
		int res = dao.withdraw(myno);
	...
	<%
		...
		MYDto dto = new MYDto(myno, id, password, name, address, phone, email);
